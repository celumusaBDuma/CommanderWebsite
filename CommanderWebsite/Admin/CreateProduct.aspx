<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CreateProduct.aspx.cs" Inherits="CommanderWebsite.Admin.CreateProduct" %>
        ...
        <table class="auto-style1" style="text-align:left">
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:TextBox ID="TxtPrdName" CssClass="form-control" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:TextBox ID="TxtPrdDesc" CssClass="form-control" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:Button ID="Button1" CssClass="btn btn-default" runat="server"  Text="Add Product" OnClick="Button1_Click" />
                    <br />
                    <br />
