...
{
    public partial class ProfileSettingsAdmin : System.Web.UI.Page
    {
                ...
                //    if (userRow.Gender != null)
                  //  {
                   ...
                   // }
                    ...
                    if (userRow.AdminType != null)
                    {
                        tbHouseNumber.Text = userRow.AdminType;
                    }
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("/Admin/ProfileSettingsAdmin.aspx");
