<%@ Page Title="Password Changed" Language="C#" AutoEventWireup="true" CodeBehind="ResetPasswordConfirmation.aspx.cs" Inherits="CommanderWebsite.Account.ResetPasswordConfirmation"  Async="true" %>
        ...
        <div class="container-fluid" style="margin: 0px; background-position: center center; padding-top: 50px; padding-bottom: 25px; padding-left: 15px; padding-right: 15px;">
            ...
            <div class="container thumbnail" style="text-align:center;width:400px;  padding-bottom: 20px ">
                <div class="row2" style="padding-left:15px;padding-right:15px;">
                    ...
                    <div>
                        <p>Your password has been changed.  <asp:HyperLink ID="login" runat="server" NavigateUrl="~/Account/Login">Click here</asp:HyperLink> to go to login </p>
                    </div>
