<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="CommanderWebsite.Views.Cart" %>
        ...
        <div align="center" style="width: 100%">
            ...
            <br />
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item active">
                                 ...
                                 <asp:Image ID="imsdf" ImageUrl="Resources/noImage.png"  Width="100%" Height="500px"
                ...
                <div style="float: left; width: 50%; margin-left: 70px;">
                 <asp:ListView ID="rprtCart" runat="server">
                            <ItemTemplate>
