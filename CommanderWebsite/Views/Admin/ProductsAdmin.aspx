<%@ Page Title="Products" Language="C#" MasterPageFile="~/Views/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ProductsAdmin.aspx.cs" Inherits="CommanderWebsite.Views.Admin.ProductsAdmin" %>
                    ...
                    <div class=" col-md-3 col-md-4" align="center">
                        ...
                        <div class="thumbnail">
                            <div align="center" style="width: 100%; height: 30%">
                                ...
                                <asp:Image ID="imgs" ImageUrl="<%#("Picture") %>"  Width="100%" Height="300px" ImageAlign="Middle" runat="server"></asp:Image>
                            </div>
                            <div class= "caption">
                                <h1><%#Eval("Name") %></h1>
