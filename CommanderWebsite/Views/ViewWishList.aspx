<%@ Page Title="View WishList" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewWishList.aspx.cs" Inherits="CommanderWebsite.Views.ViewWishList" %>
        ...
        <div align="center" style="width: 100%">
            ...
            <br />
                ...
                <div style="float: left; width: 50%; margin-left: 70px;">
                 <asp:repeater ID="rprtWishList" runat="server">
                            <ItemTemplate>
              ...
              <br />
               <br />   
                  ...
                  />  &nbsp;  &nbsp;  &nbsp;  &nbsp;<asp:button runat="server" ID="btnAddToCart" 
                        CssClass="btn" Text="Add To Cart" onclick="btnAddToCart_Click" />
                </div>
                </div>
